...
### Importação de texto disponível para desenvolvimento

O código já normaliza uma consulta ou URL HTTP(S) por linha. Linhas vazias são ignoradas, a ordem e a linha de origem são preservadas, e URLs inválidas viram erros recuperáveis. A interface para usar esse recurso ainda será implementada.
